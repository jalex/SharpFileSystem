...
namespace SharpFileSystem.IO {
    ...
    public class CircularBuffer<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable {
        ...
        public CircularBuffer(int capacity, bool allowOverflow) {
            if(capacity < 0) throw new ArgumentException("capacity must be greater than or equal to zero.", "capacity");
        ...
        public void Put(T item) {
            if(!AllowOverflow && size == capacity) throw new InternalBufferOverflowException("Buffer is full.");
        ...
        public void CopyTo(int index, T[] array, int arrayIndex, int count) {
            if(count > size) throw new ArgumentOutOfRangeException("count",  "count cannot be greater than the buffer size.");
        ...
        int ICollection.Count { get { return Size; } }
