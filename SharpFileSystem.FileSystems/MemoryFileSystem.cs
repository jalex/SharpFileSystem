...
namespace SharpFileSystem.FileSystems {
    ...
    public class MemoryFileSystem : IFileSystem {
        private IDictionary<FileSystemPath, ISet<FileSystemPath>> _directories = new Dictionary<FileSystemPath, ISet<FileSystemPath>>();
        private IDictionary<FileSystemPath, MemoryFile> _files = new Dictionary<FileSystemPath, MemoryFile>();
        ...
        public ICollection<FileSystemPath> GetEntities(FileSystemPath path) {
            ...
            if(!_directories.TryGetValue(path, out subentities)) throw new DirectoryNotFoundException();
            return subentities;
        }
        ...
        public Stream OpenFile(FileSystemPath path, FileAccess access) {
            if(!path.IsFile) throw new ArgumentException("The specified path is no file.", "path");
            MemoryFile file;
            if(!_files.TryGetValue(path, out file)) throw new FileNotFoundException();
        ...
        public void CreateDirectory(FileSystemPath path) {
            ...
            if(!_directories.TryGetValue(path.ParentPath, out subentities)) throw new DirectoryNotFoundException();
        ...
        public class MemoryFileStream : Stream {
            ...
            public override long Length { get { return _file.Content.Length; } }
